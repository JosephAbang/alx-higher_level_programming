...
In life, we always seek to have control over almost everything. It is also natural that we will want control in our programs, in fact, it is a necessity. Control Flow statements like if... elif..else and loops give us that power. This project taught me about giving the user the ability to define both the iteration step and halting condition (as C), Python’s for statement iterates over the items of any sequence (a list or a string), in the order that they appear in the sequence. 

I practiced writing my own Python functions while learning about scope of
